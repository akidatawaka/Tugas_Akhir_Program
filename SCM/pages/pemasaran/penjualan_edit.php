...
<head>
    ...
    <title>Ubah Data Produk - PT. Multi Instrumentasi</title>
...
<body>
  <script type="text/javascript">
          ...
          $query_mysql = mysqli_query($koneksi,"SELECT * FROM produk WHERE id_produk='$id_produk'") or die(mysqli_error());
          $nomor = 1;
          while ($data = mysqli_fetch_array($query_mysql)) {
          ?>

                      <h1 class="page-header">Ubah Data Produk</h1>
                    <form action="produk_edit_aksi.php" method="post" name="Form">
                      <div class="form-group">
                          <label>ID Produk : <?php echo $data['id_produk']; ?></label>
