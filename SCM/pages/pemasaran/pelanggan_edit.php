...
<head>
    ...
    <title>Ubah Data Pelanggan - PT. Multi Instrumentasi</title>
...
<body>
  <script type="text/javascript">
            ...
            {
              var nama_pelanggan = document.forms["Form"]["nama_pelanggan"].value;
              var alamat = document.forms["Form"]["alamat"].value;
              var x = confirm("Apakah Anda yakin ingin mengubah data ini ?");
              if (nama_pelanggan==null || nama_pelanggan=="",alamat==null"")
              {
          ...
          $query_mysql = mysqli_query($koneksi,"SELECT * FROM pelanggan WHERE id_PELANGGAN='$id_pelanggan'") or die(mysqli_error());
          $nomor = 1;
          while ($data = mysqli_fetch_array($query_mysql)) {
          ?>

                      <h1 class="page-header">Ubah Data Pelanggan</h1>
                    <form action="pelanggan_edit_aksi.php" method="post" name="Form">
